...
(
    ...
    'region_region_api_scope_lifetime' => env('CACHE_REGION_API_SCOPE_LIFETIME', 1140),
    'region_region_client_lifetime'    => env('CACHE_REGION_CLIENT_LIFETIME', 1140),
    ...
    'region_users_lifetime'            => env('CACHE_USERS_LIFETIME', 30),
);