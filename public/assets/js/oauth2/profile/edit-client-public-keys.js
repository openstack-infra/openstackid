(function( $ ){
    ...
    $(document).ready(function($){
        ...
        $('#usage').change(function(){
            ...
            {
                result = oauth2_supported_algorithms.content_encryption_algorihtms;
            }
            ...
            $.ajax(
                {
                    ...
                    timeout: 60000,
                    success: function (data, textStatus, jqXHR) {
                        if(public_key_data.active){
                            status_badge.removeClass('public-key-deactivated');
                            status_badge.addClass('public-key-active');
                            status_badge.attr('title', 'active');
                        }
                        else{
                            status_badge.removeClass('public-key-active');
                            status_badge.addClass('public-key-deactivated');
