...
class TokenService implements ITokenService {
    ...
    public function getAuthorizationCode($value)
    {
        ...
        $success = $this->redis->setnx('lock.get.authcode.'.$hashed_value , 1);
    ...
    public function getAccessToken($value)
    {
        ...
        if(!$this->redis->exists($hashed_value)){
            ...
            //lock ...
            $success = $this->redis->setnx('lock.get.accesstoken.'.$hashed_value , 1);
            ...
            try{
                ...
                //release lock
                $this->redis->del('lock.get.accesstoken.'.$hashed_value);
            }
            catch(Exception $ex){
                //release lock
                $this->redis->del('lock.get.accesstoken.'.$hashed_value);
