<form id="form-application-security" name="form-application-security">
    ...
    <div class="form-group">
        ...
        {{ Form::select('token_endpoint_auth_method', utils\ArrayUtils::convert2Assoc( oauth2\OAuth2Protocol::$token_endpoint_auth_methods), $client->token_endpoint_auth_method, array('class' => 'form-control', 'id' => 'token_endpoint_auth_method')) }}
    </div>
     <div class="form-group ">
    ...
    <div class="form-group">
        ...
        {{ Form::select('subject_type', utils\ArrayUtils::convert2Assoc(Client::$valid_subject_types), $client->subject_type, array('class' => 'form-control', 'id' => 'subject_type')) }}
    </div>
    <div class="form-group">
    ...
    <div class="form-group row">
        <div class="col-md-6 form-group ">
            ...
            {{ Form::select('userinfo_encrypted_response_alg', utils\ArrayUtils::convert2Assoc( oauth2\OAuth2Protocol::$supported_key_management_algorithms), $client->userinfo_encrypted_response_alg, array('class' => 'form-control', 'id' => 'userinfo_encrypted_response_alg')) }}
        </div>
        <div class="col-md-6 form-group ">
            <label for="id_token_encrypted_response_alg">Id Token Encrypted Key Algorithm&nbsp;<span class="glyphicon glyphicon-info-sign accordion-toggle"
                                                                                                     aria-hidden="true"></span></label>
            {{ Form::select('id_token_encrypted_response_alg', utils\ArrayUtils::convert2Assoc( oauth2\OAuth2Protocol::$supported_key_management_algorithms), $client->id_token_encrypted_response_alg, array('class' => 'form-control', 'id' => 'id_token_encrypted_response_alg')) }}
        </div>
    </div>
    <div class="form-group row">
        <div class="col-md-6 form-group ">
