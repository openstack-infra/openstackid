...
<form id="form-application-security-logout" name="form-application-security-logout">
    <div class="form-group">
        <label for="post_logout_redirect_uris">Post Logout Uris (optional)</label>
    ...
    <div class="form-group">
        <label for="logout_uri">Logout Uri (optional)</label>
        <input type="text" name="logout_uri" class="form-control" id="logout_uri"
               value="{{$client->logout_uri}}">
    </div>
    <div class="checkbox">
        <label>
            <input type="checkbox" id="logout_session_required" name="logout_session_required" @if ($client->logout_session_required)checked@endif>Session Required (Optional)
        </label>
    </div>
    <div class="checkbox">
        <label>
            <input type="checkbox" id="logout_use_iframe" name="logout_use_iframe" @if ($client->logout_use_iframe)checked@endif>Use IFrame (Optional)
        </label>
    </div>
