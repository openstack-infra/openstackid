    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="row">
                ...
                <div class="col-md-1">
                    <span class="glyphicon glyphicon-info-sign pointable info" aria-hidden="true" data-content="Developer Email: <a href='mailto:{{$dev_info_email}}'>{{$dev_info_email}}</a>.<br> Clicking 'Accept' will redirect you to: <a href='{{$website}}' target='_blank'>{{$website}}</a>" title="Developer Info"></span>
                </div>
            </div>
