            ...
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="panel">
                    ...
                    <div style="text-align: center">
                        <a href="{{ URL::action("UserController@getLogin")}}" class="btn btn-default btn-lg active">Sign in to your account</a>
                        <a href="{{ ServerConfigurationService::getConfigValue("Assets.Url") }}join/register"
                           class="btn btn-default btn-lg active">Register for an OpenStack ID</a>
                    </div>
