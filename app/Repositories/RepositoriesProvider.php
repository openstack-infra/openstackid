...
final class RepositoriesProvider extends ServiceProvider
{
    ...
    public function register(){
        ...
        App::singleton(\OAuth2\Repositories\IRefreshTokenRepository::class, \Repositories\EloquentRefreshTokenRepository::class);
        App::singleton(\OAuth2\Repositories\IAccessTokenRepository::class, \Repositories\EloquentAccessTokenRepository::class);
        App::singleton(\OAuth2\Repositories\IApiScopeRepository::class, \Repositories\EloquentApiScopeRepository::class);
        App::singleton(\OAuth2\Repositories\IApiRepository::class, \Repositories\EloquentApiRepository::class);
        App::singleton(\OAuth2\Repositories\IResourceServerRepository::class, \Repositories\EloquentResourceServerRepository::class);
    }
