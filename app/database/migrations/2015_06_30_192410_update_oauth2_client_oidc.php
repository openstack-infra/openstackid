...
class UpdateOauth2ClientOIDC extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('oauth2_client', function($table) {
            ...
            $table->enum("userinfo_signed_response_alg", OAuth2Protocol::$supported_signing_algorithms)->default(JSONWebSignatureAndEncryptionAlgorithms::HS256);
            // encryption
            ...
            $table->enum("id_token_signed_response_alg",    OAuth2Protocol::$supported_signing_algorithms)->default(JSONWebSignatureAndEncryptionAlgorithms::HS256);
            // encryption
