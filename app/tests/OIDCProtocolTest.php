...
class OIDCProtocolTest extends OpenStackIDBaseTest
{
    ...
    public function testUserInfoEndpointGETAndBearerHeader()
    {
        ...
        $response = $this->action("GET", "OAuth2UserApiController@userInfo",
            array(),
            array(),
            array(),
    ...
    {
        $access_token = $this->testToken();
        $response = $this->action("POST", "OAuth2UserApiController@userInfo",
            array(),
            array(),
            array(),
            array("HTTP_Authorization" => " Bearer " . $access_token));
    ...
    public function testTryingAuthCodeTwice()
    {
        ...
        $this->assertTrue($response->error === 'invalid_request');
    }

    public function testDiscovery()
    {
        $response = $this->action("GET", "OAuth2ProviderController@discovery");
    ...
    {
        $response = $this->action("GET", "OAuth2ProviderController@certs");
