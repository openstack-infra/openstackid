...
class AdminController extends Controller {
     ...
     * @param IApiScopeGroupRepository $group_repository
     */
    ...
    public function listResourceServers() {
        $user             = $this->auth_service->getCurrentUser();
        $resource_servers = $this->resource_server_service->getAll(1, PHP_INT_MAX);
    ...
    public function listLockedClients(){
        $user    = $this->auth_service->getCurrentUser();
        $clients = $this->client_service->getAll(1, PHP_INT_MAX,array(
            array(
                'name'=>'locked',
                'op' => '=',
                'value'=> true
    ...
    public function listLockedUsers(){
        $user    = $this->auth_service->getCurrentUser();
        $users   = $this->user_service->getAll(1, PHP_INT_MAX,array(
            array(
                'name'=>'lock',
                'op' => '=',
                'value'=> true
