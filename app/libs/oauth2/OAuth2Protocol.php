...
final class OAuth2Protocol implements IOAuth2Protocol
{
    ...
    static public $valid_response_types = array
    (
    ...
    static public function getValidResponseTypes($flow = 'all')
    {
        ...
        (
            ...
            // OIDC
            self::OAuth2Protocol_ResponseType_IdToken,
            self::OAuth2Protocol_ResponseType_IdToken . self::OAuth2Protocol_ResponseType_Delimiter . self::OAuth2Protocol_ResponseType_Token,
        );

        $hybrid_flow  = array
        (
            self::OAuth2Protocol_ResponseType_Code . self::OAuth2Protocol_ResponseType_Delimiter . self::OAuth2Protocol_ResponseType_IdToken,
            self::OAuth2Protocol_ResponseType_Code . self::OAuth2Protocol_ResponseType_Delimiter .self::OAuth2Protocol_ResponseType_Token,
            self::OAuth2Protocol_ResponseType_Code . self::OAuth2Protocol_ResponseType_Delimiter . self::OAuth2Protocol_ResponseType_IdToken . self::OAuth2Protocol_ResponseType_Delimiter . self::OAuth2Protocol_ResponseType_Token,
        );

        if($flow === 'all')
            return array_merge($code_flow, $implicit_flow, $hybrid_flow);
