...
final class OAuth2Protocol implements IOAuth2Protocol
{
    ...
    public function authorize(OAuth2Request $request = null)
    {
        ...
        catch (InvalidOAuth2Request $ex1)
        {
        ...
        catch(LoginRequiredException $ex13){
            ...
            return OAuth2IndirectErrorResponseFactoryMethod::buildResponse($request, OAuth2Protocol::OAuth2Protocol_Error_Login_Required, $redirect_uri);
        }
        catch(ConsentRequiredException $ex14){
            ...
            return OAuth2IndirectErrorResponseFactoryMethod::buildResponse($request, OAuth2Protocol::OAuth2Protocol_Error_Consent_Required, $redirect_uri);
        }
        catch (Exception $ex) {
