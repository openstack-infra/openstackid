...
final class ClientPlainCredentialsAuthContextValidator implements IClientAuthContextValidator
{
    ...
    public function validate(ClientAuthenticationContext $context)
    {
        ...
        return
               (
                   $context->getClient()->getTokenEndpointAuthInfo()->getAuthenticationMethod() === OAuth2Protocol::TokenEndpoint_AuthMethod_None ||
                   $context->getClient()->getTokenEndpointAuthInfo()->getAuthenticationMethod() === $context->getAuthType()
               ) &&
