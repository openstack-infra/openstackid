...
class AuthorizationCodeGrantType extends AbstractGrantType
{
    ...
    public function completeFlow(OAuth2Request $request)
    {
        ...
        try
        {
            ...
            {
                throw new InvalidRedeemAuthCodeException($this->client_auth_context->getId(),
            ...
            if($this->authCodewasIssuedForOIDC($auth_code->getScope()))
            {
                $id_token = $this->token_service->createIdToken($auth_code);
        ...
        catch (InvalidAuthorizationCodeException $ex)
        {
            ...
            throw new InvalidRedeemAuthCodeException($this->client_auth_context->getId(), $ex->getMessage());
        }
    }
